...
:::note
Creating a new site requires a paid plan ([Launch or Orbit](/pricing)). Existing sites on the free plan stay live and can still be redeployed, but launching a new site needs an upgrade.
:::
