...
<Aside type="note">Currently the CLI does not support native Windows. If you are using Windows plase use through [WSL](https://learn.microsoft.com/en-us/windows/wsl/install)!</Aside>
